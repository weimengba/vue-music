<template>
  <div class="progress-bar" ref="progressBar" @click="progressClick">
      ...
      @thouchstart.prevent="progressTouchStart"
      @touchemove.prevent="progressTouchMove"
      @touched.prevent="progressTouchEnd">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      progressTouchEnd(e) {
        this.tuoch.initiated = false
        this._triggerPercent()
      },
      progressClick() {
        this._offset(e._offsetX)
        this._triggerPercent()
      },
      _triggerPercent() {
